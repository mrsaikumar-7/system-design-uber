...
![uber-datamodel](./diagrams/uber-datamodel.png)
...
Service discoveryis another thing we will have to take into account. We can also use a service mesh that enables managed, observable, and secure communication between individual services.
...
![uber-working](./diagrams/uber-working.png)
...
Geohashing is a geocoding method used to encode geographic coordinates such as latitude and longitude into short alphanumeric strings. It was created by [Gustavo Niemeyer](https://twitter.com/gniemeyer) in 2008.
...
![geohashing](./diagrams/geohashing.png)
...
![quadtree](./diagrams/quadtree.png)
...
![quadtree-subdivision](./diagrams/quadtree-subdivision.png)
...
![uber-advanced-design](./diagrams/uber-advanced-design.png)
